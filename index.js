...
function setToArray(mySet) {
  ...
  const newArray = arr.filter((item) => typeof item === "string");
...
function iterateSet(set) {
  ...
  for (const value of iterValue) {
    console.log(value);
  }

  console.log("======entry======");
  const iterEntry = set.entries();
  for (const entry of iterEntry) {
    console.log(entry);
  }
}
